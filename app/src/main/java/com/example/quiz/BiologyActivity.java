        ...
        fab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (question3_choice1.isChecked() && question3_choice2.isChecked())
                    final_score++;
                if (question4_answer.getText().toString().toLowerCase().equals("c programming language"))
                    final_score++;
                if (question5_choice1.isChecked() && question5_choice2.isChecked() && question5_choice3.isChecked() && !question5_choice4.isChecked())
                    final_score++;
                if (question6_answer.getText().toString().toLowerCase().equals("development of web applications"))
                    final_score++;
                if (question7_choice2.isChecked())
                    final_score++;
                if (question8_answer.getText().toString().toLowerCase().equals("python virtual machine") || question8_answer.getText().toString().toLowerCase().equals("Python virtual machine"))
                    final_score++;
