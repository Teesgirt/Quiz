        ...
        fab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (question5_choice2.isChecked())
                    final_score++;
                if (question6_answer.getText().toString().toLowerCase().equals("graphics"))
                    final_score++;
                if (question7_choice1.isChecked())
                    final_score++;
                if (question8_answer.getText().toString().toLowerCase().equals("james gosling"))
                    final_score++;
                if (question9_choice3.isChecked())
                    final_score++;
                if (question10_choice3.isChecked())
                    final_score++;
